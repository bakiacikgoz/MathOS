...
const result = await Bun.build({ entrypoints: [resolve(root, "apps/vscode-extension/src/extension.ts")], outdir, target: "node", format: "esm", minify: false, external: ["vscode"] })
