...
export async function validateRetrievalHoldout() {
  ...
  for (let index = 0; index < names.length; index += 30) {
    ...
    const result = await adapter.inspectDeclarations(batch, { workspaceRoot: "/Users/yazilim/Projects/mathos/demo", formalProjectRoot: "/Users/yazilim/Projects/mathos/demo/formal" }, { timeoutMs: 180_000 })
