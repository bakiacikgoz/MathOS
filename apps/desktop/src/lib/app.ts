...
export type Route = "overview" | "assistant" | "claims" | "branches" | "graph" | "literature" | "reports" | "health" | "providers" | "console" | "settings"
...
export const NAV: Array<{ route: Route; label: MessageKey; icon: "overview" | "chat" | "claims" | "graph" | "book" | "branch" | "file" | "health" | "plug" | "console"; key: string; group: "research" | "system" }> = [
  ...
  { route: "branches", label: "nav.branches", icon: "branch", key: "6", group: "research" },
  { route: "reports", label: "nav.reports", icon: "file", key: "7", group: "research" },
  { route: "health", label: "nav.health", icon: "health", key: "8", group: "system" },
  { route: "providers", label: "nav.providers", icon: "plug", key: "9", group: "system" },
  { route: "console", label: "nav.console", icon: "console", key: "0", group: "system" },
]
