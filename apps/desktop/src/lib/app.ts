...
export type Route = "overview" | "assistant" | "claims" | "branches" | "health" | "providers" | "console" | "settings"
...
export const NAV: Array<{ route: Route; label: MessageKey; icon: "overview" | "chat" | "claims" | "branch" | "health" | "plug" | "console"; key: string; group: "research" | "system" }> = [
  ...
  { route: "health", label: "nav.health", icon: "health", key: "5", group: "system" },
  { route: "providers", label: "nav.providers", icon: "plug", key: "6", group: "system" },
  { route: "console", label: "nav.console", icon: "console", key: "7", group: "system" },
]
