import type { Workflow } from "../views/ClaimWorkflow.tsx"
...
export const useClaimPage = (root: string, id: string | null) => useQuery(id ? keys.claim(root, id) : null, () => runJson<{ claim: Claim; page: string; workflow?: Workflow }>(root, ["claim", "show", id!]))
