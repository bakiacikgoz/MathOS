...
export function Settings() {
  ...
  return (
    <div className="page-inner" style={{ maxWidth: 760 }}>
      <div className="page-head"><div><div className="eyebrow">MathOS</div><h1 className="title">{t("nav.settings")}</h1></div></div>

      <div className="settings-group">
        <div className="section-title" style={{ marginTop: 0 }}>{t("settings.appearance")}</div>
        <div className="card theme-cards">
          {themes.map((theme) => (
      ...
      <div className="settings-group">
        ...
        <div className="card"><div className="settings-row"><div className="k"><Icon name="globe" size={16} /> {t("settings.language")}</div>
