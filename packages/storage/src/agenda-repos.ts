...
export class ConjectureTriageRepository extends V1Repository<Row> { constructor(db: Database) { super(db,"conjecture_triage_results",["id","proposalId","gate","result","detail","createdAt"],["detail"],"created_at") } listForProposal(id:string){return this.list(id)} }
