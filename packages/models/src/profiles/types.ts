...
/** The model to request from an official client: "auto" leaves the choice to the client's own default. */
export const clientModel = (model: string): string | undefined => model === "auto" ? undefined : model
