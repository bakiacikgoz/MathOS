...
export interface HttpTransportConfig { provider: string; model: string; baseUrl: string; apiKey: string; timeoutMs?: number; maxResponseBytes?: number; fetch?: typeof fetch; headers?:Record<string,string>; supportedReasoningEfforts?:Array<"none"|"low"|"medium"|"high"|"max"> }
