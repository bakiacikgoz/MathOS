...
export type ProviderTermsPolicy = "STANDARD_API" | "OFFICIAL_CLIENT_BRIDGE" | "SCOPED_PLAN" | "REQUIRES_VENDOR_APPROVAL" | "PROHIBITED_THIRD_PARTY" | "RETIRED"
...
export interface ProviderDescriptor {
  ...
  terms: { policy: ProviderTermsPolicy; summary: string; officialSources: string[]; lastReviewedAt: string; userOverrideAllowed: boolean }
