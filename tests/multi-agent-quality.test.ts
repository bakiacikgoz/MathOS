...
import { approachFingerprint, assignmentDiversity, type AgentAssignmentPlan, type ResearchDecision } from "@mathos/domain"
...
async function ready() {
  ...
  const app = MathOS.open(created.root, { modelProvider: model, auditorProvider: model, leanAdapter: new FakeLeanAdapter(), vcs: new FakeVcs(), premiseRetriever: new InMemoryPremiseRetriever(), multiAgentPlanner: { async planAssignments() { return plan } } })
